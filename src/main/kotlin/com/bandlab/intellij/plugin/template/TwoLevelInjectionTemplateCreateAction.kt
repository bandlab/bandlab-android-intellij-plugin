...
class TwoLevelInjectionTemplateCreateAction :
    ...
    override fun create(newName: String, directory: PsiDirectory): Array<PsiElement> {
        val templateBuilder =
            TwoLevelInjectionTemplateBuilder(
                name = newName,
        ...
        return arrayOf(
            directory.writeFile(
                fileName = "${newName}.kt",
                content = templateBuilder.buildInterface(),
            ),
            directory.writeFile(
                fileName = "${newName}Impl.kt",
                content = templateBuilder.buildImpl(),
            ),
        )
    }
